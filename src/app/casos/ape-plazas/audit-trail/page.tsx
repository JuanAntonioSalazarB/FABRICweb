...
import { ArrowLeft, Calendar, FileText, UserCheck, ShieldCheck, Lock, ArrowRight, Sparkles } from 'lucide-react';
...
export default function CasoApePlazasAuditTrailPage() {
  ...
  const timeline: AuditEvent[] = [
    {
      ...
      evidence: "Acta formal de liberación de go-live de facturación masiva de arrendamientos en Oracle Fusion Cloud.",
    ...
    <div className="bg-black text-white min-h-screen pt-28 pb-20 px-4 font-mono text-xs selection:bg-accent selection:text-black">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex justify-between items-center">
          <Link href="/casos/ape-plazas" className="inline-flex items-center gap-2 text-accent hover:text-accent-hover font-mono text-xs transition-colors">
        ...
        <div className="border-b border-zinc-900 pb-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[10px] text-zinc-500 font-mono tracking-widest uppercase">/casos/ape-plazas/audit-trail</span>
          </div>
          <h1 className="text-3xl md:text-5xl font-serif text-white font-light mt-1">
            Registro de Auditoría Pública: APE Plazas
          </h1>
          <p className="text-zinc-400 font-sans text-sm max-w-3xl mt-2 leading-relaxed">
            Transparencia radical real. A continuación se detallan los hitos técnicos oficiales y la evidencia verificable acumulada durante la remediación y estabilización del ciclo de facturación masiva.
          </p>
        </div>
              ...
              <div className="border-t border-zinc-900 pt-6 mt-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-zinc-300 font-bold">Ing. Roberto Valdez</span>
                    <span className="text-zinc-500 text-[10px] font-sans ml-1">(Director de Finanzas y Control en APE Plazas)</span>
                  </div>
                </div>
                
                <button
                  onClick={() => handleOpenRequest('contacto-directo-ape.pdf')}
...
│                                                        │
│  · 06 abril 2026: Go-live ejecutado                    │
│    Evidencia: Acta de go-live (PDF bajo NDA)           │
│                                                        │
│  · 15 abril 2026: Cierre quincenal validado            │
│    Evidencia: Reporte de FABRIC (PDF bajo NDA)         │
│                                                        │
│  · 30 abril 2026: Cierre contable completo             │
│    Evidencia: Acta de transición firmada               │
│                                                        │
│  · Verificable por: [Director de Finanzas,             │
│    APE Plazas, accesible bajo NDA mutuo]               │
│                                                        │
└────────────────────────────────────────────────────────┘`}
            </div>
            ...
            <div className="border border-zinc-900 bg-zinc-950/40 p-4 rounded text-zinc-500 font-sans text-xs leading-relaxed">
              ...
              Para acceder a la evidencia formal o entablar contacto directo con el Director de Finanzas, es mandatorio firmar previamente el acuerdo de confidencialidad recíproco a fin de proteger la gobernanza de datos financieros del cliente original.
            </div>
        ...
        <div className="fixed inset-0 z-[2500] bg-black/85 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-zinc-950 border border-accent p-6 md:p-8 max-w-md w-full relative space-y-6">
            ...
            <button
              ...
              className="absolute top-4 right-4 text-zinc-500 hover:text-white cursor-pointer font-mono text-[10px] border border-zinc-800 px-2.5 py-1 bg-black animate-pulse"
            >
              [CERRAR X]
            </button>
